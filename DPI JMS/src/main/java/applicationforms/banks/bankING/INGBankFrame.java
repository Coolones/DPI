package applicationforms.banks.bankING;
...
public class INGBankFrame extends JFrame implements iBankFrame {
	...
	public INGBankFrame() {
		...
		gateway = new BankGateway(this, "INGBANKINTERESTREQUEST");
		...
		btnSendReply.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (rr != null) {
                    ...
                    BankInterestReply reply = new BankInterestReply(rr.getRequest().getId(), interest,"ING");
                    if (reply != null){
                        rr.setReply(reply);
                        list.repaint();
